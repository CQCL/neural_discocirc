...
TASK_FILE = '/data/tasks_1-20_v1-2/en/qa6_yes-no-questions_train.txt'
# TASK_FILE = '/../../data/tasks_1-20_v1-2/en/qa15_basic-deduction_train.txt'
SAVE_FILE = '/data/pickled_dataset/add_logits_dataset_task6_train.pkl'
...
context_file = '/src/data_generation/context_circuits_task6.txt'
