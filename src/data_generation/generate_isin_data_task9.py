...
# p = '/home/jliu/text_to_discocirc'
# sys.path.insert(1,p)

# some instructions specific to task 1
import pickle

from data_generation.generate_answer_pair_number import get_qa_numbers_task6_isin
...
TASK_FILE = '/data/tasks_1-20_v1-2/en/qa9_simple-negation_train.txt'
SAVE_FILE = '/data/pickled_dataset/isin_dataset_task9_train.pkl'
...
context_file = '/src/data_generation/context_circuits_task9.txt'
...
q_a_number_pairs = get_qa_numbers_task6_isin(context_circuits, questions, answers)
dataset = []
