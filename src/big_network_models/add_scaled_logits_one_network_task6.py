...
class AddScaledLogitsOneNetworkTrainerTask6(OneNetworkTrainerBase):
    def __init__(self,
        ...
        super(AddScaledLogitsOneNetworkTrainerTask6, self).__init__(lexicon=lexicon, wire_dimension=wire_dimension, hidden_layers=hidden_layers, **kwargs)
